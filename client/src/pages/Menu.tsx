        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">Sicilian pies served in the heart of NYC's East Village. Thick crust, square-cut pizzas with authentic Italian flavors.</p>
            </div>
