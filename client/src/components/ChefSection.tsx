      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">Our signature Margherita represents the essence of authentic Italian pizza-making. Fresh mozzarella, organic tomatoes, and aromatic basil create a harmony of flavors on our perfectly charred, wood-fired crust.</p>
            <Button
